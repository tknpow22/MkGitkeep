...
!ifdef MUI_WELCOMEPAGE
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TITLE "$(^NameDA)のセットアップを行います"
...
!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "[Page Down]をクリックして契約書をすべてお読みください。"
!endif

!ifdef MUI_COMPONENTSPAGE
  ${LangFileString} MUI_TEXT_COMPONENTS_TITLE "オプションを選んでください"
  ${LangFileString} MUI_TEXT_COMPONENTS_SUBTITLE "$(^NameDA)のインストールオプションを選んでください。"
!endif
...
!ifdef MUI_DIRECTORYPAGE
  ${LangFileString} MUI_TEXT_DIRECTORY_TITLE "インストール先を指定してください"
  ${LangFileString} MUI_TEXT_DIRECTORY_SUBTITLE "$(^NameDA)をインストールするフォルダを指定してください。"
!endif
...
!ifdef MUI_FINISHPAGE
  ${LangFileString} MUI_TEXT_FINISH_INFO_TITLE "$(^NameDA)のセットアップが完了しました。"
  ${LangFileString} MUI_TEXT_FINISH_INFO_TEXT "コンピュータに$(^NameDA)がインストールされました。$\r$\n$\r$\n[完了] をクリックしてください。"
...
!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "$(^Name)のセットアップを中止しますか?。"
!endif

!ifdef MUI_UNABORTWARNING
  ${LangFileString} MUI_UNTEXT_ABORTWARNING "$(^Name)のアンインストールを中止しますか?。"
!endif
